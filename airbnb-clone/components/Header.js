...
function Header({placeholder}) {
    ...
    return (
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10">
            ...
            {/* Left */}
            <div onClick={()=>router.push("/")} className="relative items-center h-10 cursor-pointer">
            ...
            {searchInput && ( 
                 <div className="flex flex-col col-span-3 mx-auto">
                     ...
                     <div className="flex items-center border-b mb-4">
                         ...
                         <input value={noOfGuests} onChange={(e)=>setNoOfGuests(e.target.value)} min={1} type="number" className="flex items-center w-12 pl-3 outline-none text-lg text-red-400" />
                     </div>
                     <div className="flex">
